...
const AddMovie = (props) => {
  ...
  const handleChange = (e) =>
    props.onUpdateAdd({ ...props.inputs, [e.target.name]: e.target.value });
  const handleRatingChanged = (nextValue, prevValue, name) =>
    props.onUpdateAdd({ ...props.inputs, [name]: nextValue });
  const handleAddMovie = () => {
    if (
      ...
      props.onSave([...props.list, props.inputs]);
      handleClose();
    }
  };
